 ...
 *For main program to call method of bike or car, we have to change the specify the class of the object each time while creating it.
 ...
 *So we use getbean method and pass a keyword. In order to access the getBean method, we have to make object of ApplicationContext.
...
//    	obj.drive();
    	...
    	// Also we pass the .xml file as parameter
    	...
    	objVehicle = (Vehicle) context.getBean("car"); //The default name is name is non-qualified and de-capitalized. 
    	objVehicle.drive();
